...
public class StudentMapSearch {
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.print("\nEnter a com.sample.student.Student ID to search: ");
        String searchID = scanner.nextLine();
        if (studentMap.containsKey(searchID)) {
            System.out.println("com.sample.student.Student found: " + studentMap.get(searchID));
        } else {
            System.out.println("com.sample.student.Student with ID " + searchID + " not found.");
        }
        scanner.close();
    }
}
